...
namespace API.Models {
    ...
    public class APIPart {
        ...
        private List<APIPackage> _packages = new List<APIPackage>();
        ...
        public List<APIPackage> packages {
            get {
                return this._packages;
            }
            set {
                if (value != null && value != this._packages) {
        ...
        public int? priceCode {
            ...
            set {
                if (value != null && value != this._priceCode) {
    ...
    public class APIPackage {
        ...
        public string dimensionUnitLabel { get; set; }
